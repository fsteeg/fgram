 ...
 *
 * $Id: JavaCodeGenerator.java,v 1.1 2006/03/06 00:54:28 fsteeg Exp $
 */
...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar g) throws IOException {
		...
		try {
	        ...
	        currentOutput = getPrintWriterManager().setupOutput(antlrTool, grammar);
    ...
    protected void genSemPredMap() {
        ...
        while (e.hasMoreElements())
            println("\"" + e.nextElement() + "\",", NO_MAPPING);
        println("};", NO_MAPPING);
    }
    ...
    protected void genTokenTypes(TokenManager tm) throws IOException {
		...
		try {
	    	...
	    	currentOutput = getPrintWriterManager().setupOutput(antlrTool, tm.getName() + TokenTypesFileSuffix);
