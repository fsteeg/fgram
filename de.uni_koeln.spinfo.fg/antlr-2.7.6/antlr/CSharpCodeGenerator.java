 ...
 *
 * $Id: CSharpCodeGenerator.java,v 1.1 2006/03/06 00:54:27 fsteeg Exp $
 */
			...
			if (genAST)
			{
				...
				case GrammarElement.AUTO_GEN_NONE:
					if ( usingCustomAST ||
						...
						println("astFactory.addASTChild(ref currentAST, (AST)" + astName + ");");
					else
						println("astFactory.addASTChild(ref currentAST, " + astName + ");");
					break;
				case GrammarElement.AUTO_GEN_CARET:
					if ( usingCustomAST ||
						 ( (el instanceof GrammarAtom) &&
                           (((GrammarAtom)el).getASTNodeType() != null) ) )
						println("astFactory.makeASTRoot(ref currentAST, (AST)" + astName + ");");
					else
						println("astFactory.makeASTRoot(ref currentAST, " + astName + ");");
					break;
				default:
					break;
				}
