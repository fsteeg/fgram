...
public class Term {
     ...
     */
    public Term(String det, String tense, String aspect, String number,
            String layer, String wordForm, String wordClass, String modifForm,
            String modifClass) {
        super();
...
//                tense = tense.replaceAll("prog", "").trim();
//            }
//            // TODO tense vs aspect...
//            if (tense.contains("pf")) {
//                this.perfective = true;
//                tense = tense.replaceAll("pf", "").trim();
//                // tense = "pres";
//            }
//        }
        
        //TODO transform in prolog
        this.perfective = aspect != null ? aspect.equalsIgnoreCase("pf") : false;
        this.progressive = aspect != null ? aspect.equalsIgnoreCase("prog") : false;
        ...
        this.wordForm = wordForm == null || wordForm.equals("") ? "" : wordForm
                .replaceAll("'", "");
        this.modifForm = modifForm == null || modifForm.equals("") ? ""
                : modifForm.replaceAll("'", "");
        this.children = new ArrayList<Predicate>();
    }
