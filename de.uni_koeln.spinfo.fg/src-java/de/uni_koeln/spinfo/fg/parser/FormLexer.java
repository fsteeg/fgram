...
public class FormLexer extends antlr.CharScanner implements FormParserTokenTypes, TokenStream
 {
public FormLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public FormLexer(Reader in) {
	this(new CharBuffer(in));
}
public FormLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public FormLexer(LexerSharedInputState state) {
	super(state);
