...
public abstract class PrologEngineTest extends TestCase{
	...
	public void loadTestFile(){
		engine.consultFromPackage("tests.P",PrologEngine.class);
	}
	
	/** The implementation-dependent way to construct a new PrologEngine. */
	protected abstract PrologEngine buildNewEngine();
	...
	public void testNumbers(){
		...
		*/
		String g = 
		     "ipObjectSpec('com.declarativa.interprolog.PrologEngineTest$NumberTypes',Min,["+Byte.MIN_VALUE+",SmallFloat,"+PrologEngine.MIN_INT_VALUE+","+Short.MIN_VALUE+"],_), ";
	...
	public void testDeterministicGoal(){
		...
		if (System.getProperty("java.version").compareTo("1.4.2")>=0)
			assertEquals(new Integer(32874),yetanother[2]);
