...
public abstract class PrologEngine{
	...
	/** Maximum integer value in any supported Prolog. 28 bits is all we got on XSB Prolog*/
	...
	*/
	public PrologEngine(String prologBinDirectoryOrCommand, boolean debug, boolean loadFromJar){
	...
	public static boolean isMacOS(){ // if we're under Windows  -- isWindowsOS
...
@param requester Defines where the Prolog file resides
	...
	*/
	public void setDebug(boolean d){
		if (d) System.out.println(System.currentTimeMillis()-startTime+ "ms: "+"now showing debugging informtion");
	...
	*/	
	...
	public synchronized void abortTasks(){
		...
		while(!dgThreads.empty()) dgThreads.pop();
	}
	...
	public void waitUntilAvailable(){
		try{
			while(!isAvailable()) Thread.sleep(1,1);
