...
#
# Note: Specifying any non-zero string for and ORACLE means "yes"!
#       Anything different than "no" for DLL means "yes".
#

# Modify this ##########################
JDK_LOC=E:\mc\XSBInc\XSBROOT\XSBENV\jdk
XSBLOC=E:\mc\XSBInc\XSBROOT\XSBENV\xsb
###################################
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /D "DEBUG" $(CONFIG_INCLUDE_FLAG) $(ORACLE_FLAG)\
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /I "$(JDK_LOC)\include\\" /I "$(JDK_LOC)\include\win32\\"\
 /D "$(CALL_CONV)" $(CONFIG_INCLUDE_FLAG) $(ORACLE_FLAG)\
  /Fp"$(OBJDIR)/xsb.pch" /YX /Fo"$(OBJDIR)/" /c 
...
DLL_CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG"\
 /D "_WINDOWS"\ /D "DEBUG" $(CONFIG_INCLUDE_FLAG) $(ORACLE_FLAG)\
...
DLL_LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /out:"$(DLLDIR)\xsb.dll"\
 /implib:"$(DLLDIR)/xsb.lib"	 
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /I "$(JDK_LOC)\include\\" /I "$(JDK_LOC)\include\win32\\"\
 /D "DEBUG" $(CONFIG_INCLUDE_FLAG) $(ORACLE_FLAG) /D "$(CALL_CONV)" \
  /Fp"$(OBJDIR)/xsb.pch" /YX /Fo"$(OBJDIR)/" /Fd"$(INTDIR)/" /c 
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib $(SOCKET_LIBRARY) "$(SITE_LIBS)" $(DLLDIR)"\xsb.lib"\
