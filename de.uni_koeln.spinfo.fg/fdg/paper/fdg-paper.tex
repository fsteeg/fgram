...
\captionabove{ANTLR parser rules for RL structures} \label{antlr-rl-parser}
\end{figure}
...
\captionabove{ANTLR lexer rules for RL structures} \label{antlr-rl-lexer}
\end{figure}

\begin{figure}
\begin{center}
\epsfig{file=../tree-part.pdf, width=15cm}
\end{center}
\captionabove{Part of the parse tree for the expression in Fig. \ref{fdg-rl}} \label{antlr-tree}
\end{figure}
